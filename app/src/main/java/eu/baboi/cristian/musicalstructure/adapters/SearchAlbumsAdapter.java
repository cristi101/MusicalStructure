...
public class SearchAlbumsAdapter extends ListAdapter<Model.SimplifiedAlbum, Model.AlbumSearch, AlbumsViewHolder, SearchAlbumsAdapter> {

    public SearchAlbumsAdapter(Model.AlbumSearch paging, AppCompatActivity context) {
    ...
    Loaders.Id loader() {
        return Loaders.Id.ALBUMS_PAGING;
    }
